...
I'm going to create a fake predictions object that predicts that all values of "Above_Median" in the competition dataset are "No". You would, of course, use your actual predictions from your model. You don't need to run this next chunk. 
```{r}
x = rep("No", times= 877)
df1 =data.frame(x)
df1
...
```{r}
kaggle = competition %>% select(ID) #creating a data frame with just the ID number from competition
